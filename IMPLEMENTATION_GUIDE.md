...
Convert UNS Simulator from hardcoded IP configuration (e.g., `10.159.130.81`) to environment-driven configuration using `.env` file.
...
function getBrowserAccessibleUrl(brokerUrl: string): string {
  const dockerServiceMappings: Record<string, string> = {
    'uns-mqtt': '10.159.130.81',  // HARDCODED IP
    'mqtt': '10.159.130.81',
...
### Scenario: Deploy to 10.159.130.81 (Your Current IP)
...
nano .env
# Change:
#   FRONTEND_PUBLIC_URL=http://10.159.130.81:9071
#   VITE_API_URL=http://10.159.130.81:9071/graphql
#   VITE_MQTT_SERVER_URL=10.159.130.81
...
# 7. Access
# Open browser: http://10.159.130.81:9071
...
### Old Way
❌ IP `10.159.130.81` hardcoded in 3 files  
